...
function sortWingmen() {
    ...
    var squadronBomberWingmen = document.getElementsByClassName('alliedBomberGroupSort');
    //Why is bad code making this work? LOL Don't remove it....
